...
class ABB {
    protected:
        ...
        public:
            ...
            virtual void insertar_rama (nodoBB<T>* &nodo, T dato){
            ...
            virtual void eliminar_rama (nodoBB<T>* &nodo, T dato){
            ...
            virtual void sustituir (nodoBB<T>* &eliminar, nodoBB<T>* &sust){
