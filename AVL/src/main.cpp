    ...
    while (opcion != 3){  
        ...
        switch (opcion){
            case 1:{  // Si se ha elegido el modo demostración...
                ...
                AVL<Dni> avl;  // Se crea el AVL vacío
                cout << endl;
                avl.mostrar();  // Se muestra el avl vacío
                cout << endl;
                ...
                while (opcion_demo != 3){  
                    ...
                    switch (opcion_demo){
                        case 1:{  
                            ...
                            cin >> aux;
                            Dni new_dni(aux);
                            avl.insertar(new_dni);  // Se inserta la clave en el avl
                            cout << endl;
                            avl.mostrar();  // Se muestra cómo ha quedado el avl
                            cout << endl;
                            break;
                        }
                        case 2:{  
                            ...
                            cin >> aux;
                            Dni new_dni(aux);
                            avl.eliminar(new_dni);  // Se elimina la clave del avl
                            cout << endl;
                            avl.mostrar();  // Se muestra
                            cout << endl;
                            break;
                        }
                        case 3:{  //salir
            ...
            case 2:{  
                ...
                // Se realiza la búsqueda en el avl de los nPruebas elementos extraídos de las N primeras posiciones del banco de pruebas
                for (int i=0; i<nPruebas; i++){
                    ...
                    avl.buscar(banco_pruebas[alea]);  // Se busca en el avl el elemento del banco de pruebas correspondiente a la última posición generada
                ...
                pos.clear(); 
                pos.resize(nPruebas);  
                // Se realiza la búsqueda en el avl de los nPruebas elementos extraídos de las N últimas posiciones del banco de pruebas
                for (int i=0; i<nPruebas; i++){
                    contador = 0;  // Se reinicia el contador
                    iguales = true;
                    // Mientras la posición generada ya haya sido escogida, se escoge otra aleatoriamente
